...
8086 Assembly Language Project Report &amp; Code
Code Section
;RockPaperScissors Vs Computer Game
...
Project Description:
This project presents the implementation of a Rock Paper Scissors game using 8086 As-
sembly Language in emu8086. The game allows a player to compete against the computer
through a text-based interactive interface. The system takes user input, generates a ran-
dom computer move using BIOS timer interrupts, compares both selections, and displays
the final result as win, lose, or draw.
The project was developed to demonstrate the practical implementation of assembly
language concepts including BIOS interrupts, DOS interrupts, control structures, condi-
tional branching, loops, labels, arithmetic operations, and procedures. BIOS interrupt
10H was used for screen handling and interface formatting, while DOS interrupt 21H was
used for displaying messages and taking user input.
The outcome of the project is a fully functional assembly-based game that runs suc-
cessfully in emu8086.

Run instructions:
1-In the Emulator control window, click the Run button.
2-A black output screen will pop up displaying the game interface. Use your keyboard to enter your choice (1, 2, or 3) and follow the on-screen prompts to play!
3-Choose any random number between 1,2,3. 
4-After number choosen by user computer will make its own move and show results. 
5-After result display option will pop up to replay with yes(y)/no(n) option. 
6-by pressing yes user can play again while by pressing no user can exit from the game.

Contributions:

Imama Gul(01-135232-033):
• UI Design (Menu Display)
• Random Logic (Computer Choice Generation)
• Display of Choices (Player and Computer)
• Input Handling (Keyboard)
https://github.com/ImamaGul

Sarah Naseer(01-135232-088):
• Result Processing (Win/Lose/Draw Logic)
• Replay Module (Play Again Functionality)
• Score Tracking and Display
• Program Flow Control and Integration
https://github.com/Sarah-naseer
